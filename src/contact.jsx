    ...
    <section id="contact">
      ...
      <div className="contact-info-upper-container" data-aos="flip-up" data-aos-delay="300">
        <div className="contact-info-container">
          ...
          <p><a href="mailto:vipuldhoraliya16@gmail.com">vipuldhoraliya16@gmail.com</a></p>
        </div>
        <div className="contact-info-container">
          <img src={linkedinIcon} alt="LinkedIn icon" className="icon contact-icon" />
          <p><a href="https://www.linkedin.com/in/vipul-dhoraliya-13151b345/" target="_blank">LinkedIn</a></p>
        </div>
      </div>
    </section>
  );
